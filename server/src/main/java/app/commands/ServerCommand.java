...
/**
 * Абстрактный класс, классы серверных команд наследуются от него и реализуют метод execute()
 */
public abstract class ServerCommand implements ExecutableForServerCommand, Serializable{
    @Serial
